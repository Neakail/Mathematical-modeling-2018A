...
def read_third_layer():
    temp_list = []
    data = xlrd.open_workbook('first_problem_third_layer_7.xls')
    table = data.sheets()[0]
    nrows = table.nrows
...
if __name__ == '__main__':
    ...
    for i in third_layer:
        ...
        temp_data[1:51] = list_K
        temp_data.append((temp_data[1]+temp_data[50]) / 2)
        print temp_data
        all_data.append(temp_data)

    write_in_xlwt(all_data, 'first_problem_fourth_layer_7.xls')