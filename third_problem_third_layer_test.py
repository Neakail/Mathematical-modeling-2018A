...
def read_second_layer():
    temp_list = []
    data = xlrd.open_workbook('third_problem_second_layer_test.xls')
    table = data.sheets()[0]
    nrows = table.nrows
...
if __name__ == '__main__':
    ...
    for i in first_layer:
        ...
        temp_data[1:37] = list_K
        temp_data.append((temp_data[1]+temp_data[36]) / 2)
        # print temp_data
        all_data.append(temp_data)
    write_in_xlwt(all_data, 'third_problem_third_layer_test.xls')