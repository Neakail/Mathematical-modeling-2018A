...
if __name__ == '__main__':
    all_data = []
    list_K = [65,37,37,37,37,37,37]
    for each_time in xrange(1,3601):
        temp_data = []
        temp_list = [65]
        ...
        temp_data.append((temp_data[1]+temp_data[6])/2)
        all_data.append(temp_data)
    write_in_xlwt(all_data,'second_problem_first_layer_1.xls')